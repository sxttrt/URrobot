...
workspace_limits = np.asarray([[-0.385, -0.34], [-0.34, -0.26], [0.12, 0.20]])
       
calib_grid_step = 0.04 #0.05
#checkerboard_offset_from_tool = [0,-0.13,0.02]  # change me!
checkerboard_offset_from_tool = [0,-0.133,0]
tool_orientation = [1.18,-1.2,1.13] # [0,-2.22,2.22] # [2.22,2.22,0]
...
robot = UR_Robot(robot_ip="192.168.1.35", gripper_port ='COM6', gripper_baudrate=115200, gripper_address=1,
                 workspace_limits=workspace_limits, is_use_robot=True, is_use_camera=True)
# robot.open_gripper()
...
print('Saving...')
np.savetxt('C:/Users/LCT/Desktop/URrobot/GRCNN/real/cam_pose/camera_depth_scale.txt', camera_depth_offset, delimiter=' ')
get_rigid_transform_error(camera_depth_offset)
camera_pose = np.linalg.inv(world2camera)
np.savetxt('C:/Users/LCT/Desktop/URrobot/GRCNN/real/cam_pose/camera_pose.txt', camera_pose, delimiter=' ')
print('Done.')
